...
Zentrales Log. Jede Frage gehört zu einer Ebene und blockiert deren Abschluss.
Beantwortete Fragen werden nicht gelöscht, sondern auf `beantwortet` gesetzt und
mit dem Dokument verlinkt, in dem die Antwort festgehalten wurde.
...
## Hypothesen (übernommen aus dem Briefing, noch nicht validiert)

Diese Strukturideen stammen aus dem initialen Briefing. Sie gelten als Hypothesen
und werden erst beim Erreichen der jeweiligen Ebene geprüft — nicht als gesetzt behandelt.

| ID | Ebene | Hypothese | Status |
|---|---|---|---|
| H-001 | Operating Model | Fachliche Domains mit je einem Owner (Leadership, Material, Kommunikation, Medien, Finanzen, Ausbildung, Veranstaltungen, IT, Gebet) | unvalidiert |
| H-002 | Operating Model | Große Veranstaltungen laufen über Projektteams statt über den SLK | unvalidiert |
| H-003 | Operating Model | SLK setzt nur Richtung, Prioritäten, Leitplanken und entwickelt Leiter | unvalidiert |
| H-004 | Werkzeuge | RRBase vereint Kommunikation, Handbuch, Wissen, Logbuchprüfungen, Prozesse | unvalidiert — abhängig von allen vorherigen Ebenen |
